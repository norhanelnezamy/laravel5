...
<!-- BEGIN LOGO -->
<div class="logo">
    <img src="{{admin_assets}}/assets/img/logo-big.png" alt="" />
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
<div class="content">
    <!-- BEGIN LOGIN FORM -->
    {!! Form::open(['class'=>'form-vertical login-form']) !!}
        <h3 class="form-title">{{trans('admin.login_title')}}</h3>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <div class="input-icon left">
                    <i class="icon-user"></i>
                    <input class="m-wrap placeholder-no-fix" type="text" autocomplete="off" placeholder="{{trans('admin.email')}}" name="email"/>
                </div>
            </div>
        </div>
        <div class="control-group">
            ...
            <div class="controls">
                <div class="input-icon left">
                    <i class="icon-lock"></i>
                    <input class="m-wrap placeholder-no-fix" type="password" autocomplete="off" placeholder="{{trans('admin.password')}}" name="password"/>
                </div>
            </div>
        </div>
        <div class="form-actions">
            ...
            <button type="submit" class="btn blue pull-right">
                {{trans('admin.login')}} <i class="m-icon-swapright m-icon-white"></i>
            </button>
        </div>
...
<!-- BEGIN COPYRIGHT -->
<div class="copyright">
    2015 &copy; Metronic - Admin Dashboard
</div>
<!-- END COPYRIGHT -->
